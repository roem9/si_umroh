...
<section class="py-3">
  <div class="row">
    <div class="col-md-8 me-auto text-left text-light">
      ...
      <p>Menu ini berisikan list kelas yang Anda ambil</p>
    </div>
  </div>
...
<script>
  ...
  function alertKelas() {
    Swal.fire({
      icon: 'error',
      title: 'Oops...',
      text: 'Akses kelas telah habis, Silakan menghubungi admin terlebih dahulu'
    })
  }

  function showData() {
    $.ajax({
      url: '<?= base_url()?>/memberArea/getAllKelas',
      type: "GET",
      success: function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          let sertifikat = '';
          if (obj.sertifikat == 1 /* || obj.progress == 100 */) {
            sertifikat = `
          ...
          let access = '';
          if (obj.access == 0 && obj.tipe_kelas != 'Unlimited Access' ) {
            access = `
              <a href='javascript:void(0)' onclick='alertKelas()'>
                <span class="badge bg-gradient-warning">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM4.5 7.5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-7z"/>
                  </svg>
            ...
            obj.progress = 0;
          } else if (obj.is_active == 0 && obj.tipe_kelas == 'Unlimited Access' ) {
            access = `
              <a href='javascript:void(0)' onclick='alertKelas()'>
                <span class="badge bg-gradient-warning">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-circle-fill" viewBox="0 0 16 16">
