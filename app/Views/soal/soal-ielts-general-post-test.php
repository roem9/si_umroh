<?= $this->extend('soal/layout/soal_layout') ?>

<?= $this->section('sesi-listening') ?>
    <div class="shadow card mb-3">
        <div class="card-body">
            <center>
                <audio id="audio-1" class="audio" data-id="1"><source src="<?= base_url('public/assets/myaudio/listening-academic-general-post-test.mp3?t='.time())?>" type="audio/mpeg"></audio>
    ...
    <div class="shadow card mb-3 soal">
        <div class="card-body ps-4">
            ...
            <center><span><p class="question">SHORT STAY ACCOMMODATION</p></span></center>
            <p>
                Example:<br>
    ...
    <div class="shadow card mb-3 soal">
        <div class="card-body ps-4">
            ...
            <center><p class="question">“Globalisation and Educational Change”</p></center>
            <p>
...
<?= $this->section('sesi-reading') ?>
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>How to Choose your Builder</p></center></p>
            <div class='reading-1'>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>Island Adventure Activities</p></center></p>
            <div class='reading-2'>
                ((p1))
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>Barrington Music Service: <br> Business and Development Manager</p></center></p>
            <div class='reading-3'>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>Health and Safety in Small Businesses</p></center></p>
            <div class='reading-4'>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>Jobs in Ancient Egypt</p></center></p>
            <div class='reading-5'>
