...
<?= $this->section('sesi-listening') ?>
    <div class="card mb-3">
        <div class="card-body">
            <center>
                <audio id="audio-1" class="audio" data-id="1"><source src="<?= base_url('public/assets/myaudio/listening-gt-003.mp3?t='.time())?>" type="audio/mpeg"></audio>
    ...
    <div class="card mb-3">
        <div class="card-body ps-4">
            ...
            <center>
                <table class="tableSoal w-50 mb-2 mt-2">
                    <tr>
    ...
    <div class="card mb-3">
        <div class="card-body ps-4">
            ...
            <center><p class="question"><b>Ceramics</b></p></center>
            ...
            <center><p class="question"><b>Glass</b></p></center>
            ...
            <center><p class="question"><b>Concrete</b></p></center>
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                            ...
                            <center>
                                <table class="tableSoal w-100 mb-2 mt-2">
                                    <tr>
