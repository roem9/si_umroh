                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center mt-4 mb-4">
                                <a href="javascript:void()"><img src="<?= $logo?>" height="80" alt="" class="img-fluid"></a>
                            </div>
                            <div class="mb-2 mt-3">
                                            ...
                                            <div class="shadow card mb-3">
                                                <div class="card-body ps-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        (c) Desalination plants can convert seawater into fresh water, but are very <b>40)</b> <?= soal_isian_ielts("jawaban_listening[39]")?> to pirate and maintain. <br>
                                                    </div>
                                                </div>
                                            </div>
