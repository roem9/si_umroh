...
<?= $this->section('sesi-listening') ?>
    ...
    <div class="shadow card mb-3 soal">
        <div class="card-body ps-4">
            ...
            <center><span><p class="question">Details of Claim Form</p></span></center>
            <center>
    ...
    <div class="shadow card mb-3 soal">
        <div class="card-body ps-4">
            ...
            <center><span><p class='question'>Dreamtime Tours</p></span></center>
            <center>
                <table class="tableSoal w-100">
                    <tr>
...
<?= $this->section('sesi-reading') ?>
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>TRANSITION CARE FOR THE ELDERLY</p></center></p>
            <p class='reading-1'>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>CABIN BAGS FOR AIR TRAVEL</p></center></p>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>College Car Parking Policy – Staff</p></center></p>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>Maternity Benefits</p></center></p>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>PAPYRUS</p></center></p>
            <p>
                <i>
