...
<?= $this->section('sesi-listening') ?>
    <div class="shadow card mb-3">
        <div class="card-body">
            <center>
                <audio id="audio-1" class="audio" data-id="1"><source src="<?= base_url('public/assets/myaudio/listening-academic-general-pretest.mp3?t='.time())?>" type="audio/mpeg"></audio>
...
<?= $this->section('sesi-reading') ?>
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>Organic Farming and Chemical Fertilisers</p></center></p>
            <span>A</span><br>
    ...
    <div class="shadow card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>The Pearl</p></center></p>
            <span>A</span><br>
