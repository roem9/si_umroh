...
<?= $this->section('sesi-listening') ?>
    ...
    <div class="card mb-3 soal">
        <div class="card-body ps-4">
            ...
            <center><span><p><b>SHORT STAY ACCOMMODATION</b></p></span></center>
            <p>
                Example:<br>
    ...
    <div class="card mb-3 soal">
        <div class="card-body ps-4">
            ...
            <center><p><b>“Globalisation and Educational Change”</b></p></center>
            <p>
...
<?= $this->section('sesi-reading') ?>
    <div class="card mb-3">
        <?php
            $text = "
            <p><center><p class='question'>Glass Capturing the Dance of Light</p></center></p>
            <span>A</span><br>
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                            ...
                            <img src="<?= base_url()?>public/assets/img-soal/academic_post_test_6_8.png" alt="" class="img-fluid">
    ...
    <div class="card mb-3">
        <?php
            $text = "
                <p><center><p class='question'>Why Some Women Cross the Finish Line Ahead of Men</p></center></p>
                <p><i>RECRUITMENT</i></p>
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                            ...
                            <table class="tableSoal w-100 mb-3" style="width: 100%">
                                <tr>
                                    <td><i>Example</i></td>
                                    <td><i>Answer</i></td>
                                </tr>
    ...
    <div class="card mb-3">
        <?php
            $text = "
                <p><center><p class='question'>Population Viability Analysis</p></center></p>
