...
<?= $this->section('sesi-listening') ?>
    <div class="card mb-3">
        <div class="card-body">
            <center>
                <audio id="audio-1" class="audio" data-id="1"><source src="<?= base_url('public/assets/myaudio/listening-003.mp3?t='.time())?>" type="audio/mpeg"></audio>
    ...
    <div class="card mb-3">
        <div class="card-body ps-4">
            ...
            <div class="row">
                <div class="col-8">
                    <img src="<?= base_url()?>public/assets/img-soal/003_15-20.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-4">
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                            ...
                            <center><img src="<?= base_url()?>public/assets/img-soal/003_20-26.jpeg" alt="" class="img-fluid"></center>
