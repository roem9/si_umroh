  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" name="fk_id_pertemuan_program_kelas" id="fk_id_pertemuan_program_kelas" value="<?= $pk_id_pertemuan_program_kelas ?>">
        <form id="formMateriPertemuan">
          ...
          <input type="hidden" name="pk_id_materi_pertemuan_kelas" id="pk_id_materi_pertemuan_kelas">
...
<script>
  ...
  function showData(id_pertemuan) {
    $.ajax({
      url: `<?= base_url()?>/programclientarea/getAllMateriPertemuanKelas/${id_pertemuan}`,
      type: "GET",
        ...
        if (data.length > 0) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (i == 0) {
              if (data.length == 1) {
                ...
                urutan = `
                          <a href="javascript:void(0)">
                            <span class="badge badge-sm bg-gradient-dark ms-1" onclick="ubahUrutanMateri(${obj.pk_id_materi_pertemuan_kelas}, ${obj.urutan}, 'turun', ${data[i+1].pk_id_materi_pertemuan_kelas})">
              ...
              urutan = `
                        <a href="javascript:void(0)">
                          <span class="badge badge-sm bg-gradient-dark ms-1" onclick="ubahUrutanMateri(${obj.pk_id_materi_pertemuan_kelas}, ${obj.urutan}, 'naik', ${data[i-1].pk_id_materi_pertemuan_kelas})">
            ...
            if (obj.item == 'text' || obj.item == 'video') {
              action = `
                <a href='javascript:void(0)' onclick='hapusMateriPertemuan(${obj.pk_id_materi_pertemuan_kelas}, "${obj.item}")'><span class="badge badge-sm bg-gradient-danger me-1">hapus</span></a>
                <a href='javascript:void(0)' onclick='editMateriPertemuan(${obj.pk_id_materi_pertemuan_kelas}, "${obj.item}")'><span class="badge badge-sm bg-gradient-success">edit</span></a>
                ${urutan}
              `
            } else {
              action = `
  ...
  function simpanMateriPertemuan(e) {
    ...
    let pk_id_materi_pertemuan_kelas = $(`${form} #pk_id_materi_pertemuan_kelas`).val();
    let item = $(`${form} #item`).val();

    var fd = new FormData();
    fd.append('fk_id_pertemuan_program_kelas', fk_id_pertemuan_program_kelas);
    fd.append('pk_id_materi_pertemuan_kelas', pk_id_materi_pertemuan_kelas);
    fd.append('item', item);
    ...
    if(item == 'audio' || item == 'file' || item == 'image'){
      Swal.fire({
    ...
    $.ajax({
      url: "<?= base_url()?>/programclientarea/simpanMateriPertemuanKelas",
      type: "POST",
      dataType: "json",
      contentType: false,
      processData: false,
  ...
  function editMateriPertemuan(pk_id_materi_pertemuan) {
    ...
    $.ajax({
      url: "<?= base_url()?>/programclientarea/getMateriPertemuanKelas/" + pk_id_materi_pertemuan,
      type: "get",
      dataType: "json",
      success: function(response) {
        if (response) {
          ...
          $(`#formMateriPertemuan #pk_id_materi_pertemuan_kelas`).val(response.pk_id_materi_pertemuan_kelas);
          $(`#formMateriPertemuan #fk_id_pertemuan_program`).val(response.fk_id_pertemuan_program);
  ...
  function hapusMateriPertemuan(pk_id_materi_pertemuan, tipe) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/programclientarea/hapusMateriPertemuanKelas/" + pk_id_materi_pertemuan,
          type: "get",
          dataType: "json",
          success: function(response) {
            Toast.fire({
  ...
  function ubahUrutanMateri(pk_id_materi_pertemuan_kelas, urutan, arah, pk_id_materi_pertemuan_kelas_other) {
    $.ajax({
      url: "<?= base_url()?>/programclientarea/ubahUrutanMateriKelas",
      type: "POST",
      dataType: "JSON",
      data: {
        pk_id_materi_pertemuan_kelas: pk_id_materi_pertemuan_kelas,
        pk_id_materi_pertemuan_kelas_other: pk_id_materi_pertemuan_kelas_other,
        urutan: urutan,
        arah: arah
      },
      success: function(response) {
