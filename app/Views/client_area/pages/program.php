...
<script>
  ...
  function showData(nama_program) {
    let web = "";
    (nama_program == "") ? web = '<?= base_url()?>/programclientarea/getAllProgram': web = '<?= base_url()?>/programclientarea/getListProgram/' + nama_program
    $.ajax({
      url: web,
      type: "GET",
      dataType: "json",
                  ...
                  <div class="d-flex">
                    ...
                    <div class="ms-auto">
                      <div class="dropdown">
                        ...
                        <a class="dropdown-item" href="designProgram/${obj.pk_id_program}">
  ...
  function tambahProgram(e) {
    ...
    $.ajax({
      url: "<?= base_url()?>/programclientarea/simpan",
      type: "POST",
      contentType: false,
      processData: false,
      cache: false,
  ...
  function editProgram($id) {
    ...
    $.ajax({
      url: "<?= base_url()?>/programclientarea/getProgram/" + $id,
      type: "get",
  ...
  function duplicateProgram($id) {
    $.ajax({
      url: "<?= base_url()?>/programclientarea/duplicateProgram/" + $id,
      type: "get",
      dataType: "json",
      success: function(response) {
          Toast.fire({
  ...
  function hapusProgram(id, nama_program) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/programclientarea/hapusProgram/" + id,
          type: "get",
          success: function(hasil) {
            if (result.isConfirmed) {
