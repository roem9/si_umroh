      ...
      <div class="row gx-4">
        ...
        <div class="col">
          <div class="h-100">
            ...
            <p>
              <a href="javascript:void(0)" onclick="detailKelas(<?= $kelas['id_kelas']?>, '<?= $kelas['nama_kelas']?>')">
...
<script>
    ...
    function showData(id_kelas) {
      ...
      $.ajax({
        url: `<?= base_url()?>/pengajarArea/getAllPertemuanKelas/${id_kelas}`,
        type: "GET",
          ...
          if (data.length > 0) {
            ...
            for (var i = 0; i < data.length; i++) {
              ...
              if(obj.tipe_latihan == 'Tidak Ada Latihan' || obj.tipe_latihan == 'Pre Test TOEFL Listening' || obj.tipe_latihan == 'Pre Test TOEFL Structure' || obj.tipe_latihan == 'Pre Test TOEFL Reading' || obj.tipe_latihan == 'Pre Test TOEFL' || obj.tipe_latihan == 'Post Test TOEFL Listening' || obj.tipe_latihan == 'Post Test TOEFL Structure' || obj.tipe_latihan == 'Post Test TOEFL Reading' || obj.tipe_latihan == 'Post Test TOEFL') {
                ...
                latihan = `<a target="_blank" href="<?= base_url()?>/program/latihanPertemuanKelas/${obj.pertemuanID}" class="me-1">
              ...
              if (obj.is_show != '1') {
                is_show = `
                <a href="javascript:void(0)" data-id= "${obj.id_pertemuan}" class="btnToggleIsShowPertemuan me-1">
                ...
                is_show = `
                <a href="javascript:void(0)" data-id= "${obj.id_pertemuan}" class="btnToggleIsShowPertemuan me-1 text-info">
                ...
                <tr>
                  ...
                  <td class="w-1">
                    <div class="text-center">
                      ...
                      <a target="_blank" href="<?= base_url()?>/program/materiPertemuanKelas/${obj.pertemuanID}" class="me-1">
    ...
    $(document).on("click", ".btnToggleIsShowPertemuan", function() {
      ...
      $.ajax({
          url: `<?= base_url()?>/pengajarArea/toggleIsShowPertemuan/${id_pertemuan}`,
          type: "GET",
          success: function(data) {
              data = JSON.parse(data)
          ...
          success: function(data) {
              ...
              if(data.length > 0 ){
                for (var i = 0; i < data.length; i++) {
                  ...
                  if(obj.isHadir == '1'){
                    isHadir = `
                    <a href="javascript:void(0)" data-id= "${obj.id_pertemuan}|${obj.id_member}" class="btnToggleIsHadir me-1 text-info">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-toggle-on" viewBox="0 0 16 16">
                    <path d="M5 3a5 5 0 0 0 0 10h6a5 5 0 0 0 0-10zm6 9a4 4 0 1 1 0-8 4 4 0 0 1 0 8"/>
                    </svg>
                    </a>
                    ...
                    isHadir = `
                    <a href="javascript:void(0)" data-id= "${obj.id_pertemuan}|${obj.id_member}" class="btnToggleIsHadir me-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-toggle-off" viewBox="0 0 16 16">
                        <path d="M11 4a4 4 0 0 1 0 8H8a5 5 0 0 0 2-4 5 5 0 0 0-2-4zm-6 8a4 4 0 1 1 0-8 4 4 0 0 1 0 8M0 8a5 5 0 0 0 5 5h6a5 5 0 0 0 0-10H5a5 5 0 0 0-5 5"/>
                      </svg>
                    </a>`;
    ...
    function detailKelas(id_kelas, nama_kelas) {
      ...
      $.ajax({
        url: "<?= base_url()?>/kelas/getDetailKelas/" + id_kelas,
        type: "get",
        dataType: "JSON",
        success: function(result) {
          ...
          if(peserta.length == 0){
            ...
            peserta.forEach(peserta => {
              html += `<li class="list-group-item ps-0"><a href="javascript:void(0)" class="text-dark" onclick="showDetailPeserta(${peserta.id_kelas_member}, '${peserta.nama_member}')">${peserta.nama_member}</a></li>`
            });
          }
