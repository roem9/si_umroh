    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="formLatihanPertemuan">
          ...
          <input type="hidden" name="pk_id_latihan_pertemuan" id="pk_id_latihan_pertemuan">
...
<script>
  ...
  function showData(pk_id_pertemuan_program) {
    $.ajax({
      url: `<?= base_url()?>/program/getAllLatihanPertemuan/${pk_id_pertemuan_program}`,
      type: "GET",
  ...
  function simpanLatihanPertemuan(e) {
    ...
    let pk_id_latihan_pertemuan = $(`#formLatihanPertemuan #pk_id_latihan_pertemuan`).val();
    let item = $(`#formLatihanPertemuan #item`).val();

    var fd = new FormData();
    fd.append('fk_id_pertemuan_program', fk_id_pertemuan_program);
    fd.append('pk_id_latihan_pertemuan', pk_id_latihan_pertemuan);
    fd.append('item', item);
    ...
    $.ajax({
      url: "<?= base_url()?>/program/simpanLatihanPertemuan",
      type: "POST",
      dataType: "json",
      contentType: false,
      processData: false,
  ...
  function editLatihanPertemuan(pk_id_latihan_pertemuan) {
    $.ajax({
      url: "<?= base_url()?>/program/getLatihanPertemuan/" + pk_id_latihan_pertemuan,
      type: "get",
      success: function(hasil) {
        ...
        if (obj.pk_id_latihan_pertemuan != '') {
          ...
          $(`#formLatihanPertemuan #fk_id_pertemuan_program`).val(obj.fk_id_pertemuan_program);
  ...
  function hapusLatihanPertemuan(pk_id_latihan_pertemuan, tipe) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/program/hapusLatihanPertemuan/" + pk_id_latihan_pertemuan,
          type: "get",
          success: function(hasil) {
            if (result.isConfirmed) {
  ...
  function ubahUrutanLatihan(pk_id_latihan_pertemuan, urutan, arah, pk_id_latihan_pertemuan_other) {
    $.ajax({
      url: "<?= base_url()?>/program/ubahUrutanLatihan",
      type: "POST",
      data: {
