      ...
      <div class="d-lg-flex">
        <div>
          ...
          <p class="text-sm mb-0">
            Notifikasi member yang telah melewati batas kehadiran
          </p>
        </div>
      </div>
    </div>
            ...
            <table class="table text-dark table-hover align-items-center mb-0" id="table-member">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder desktop">isNotif</th>
                  ...
                  <!-- <th class="text-uppercase text-dark text-xxs font-weight-bolder desktop">Absen</th> -->
...
<script>
  ...
  function showData() {
    $('#table-member').DataTable({
      processing: true,
      serverSide: true,
      ajax: `<?= base_url()?>/member/getListMemberNotifAbsen`,
      responsive: {
        details: {
            type: 'column'
        }
