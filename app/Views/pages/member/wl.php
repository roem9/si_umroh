...
<script>
  ...
  function showData() {
    $('#table-member').DataTable({
      processing: true,
      serverSide: true,
      ajax: `<?= base_url()?>/member/getListWL`,
      responsive: {
        details: {
            type: 'column'
        }
  ...
  function hapusWL(pk_id_kelas_member, nama_member, program) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/member/hapusKelasOfMember/" + pk_id_kelas_member,
          type: "get",
          dataType: "json",
  ...
  function editWL(pk_id_kelas_member){
    $.ajax({
      url: "<?= base_url()?>/member/getDataWL/" + pk_id_kelas_member,
      type: "get",
      dataType: "json",
      success: function(response) {
        let form = '#formEditWL';
  ...
  function simpanWL(){
    ...
    $.ajax({
        url: "<?= base_url()?>/member/editKelasWLMember",
        type: "POST",
        data: data,
        dataType: "json",
        success: function(response) {
