  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" name="fk_id_pertemuan_program" id="fk_id_pertemuan_program" value="<?= $pk_id_pertemuan_program ?>">
...
<script>
  ...
  function showData(id_pertemuan) {
    $.ajax({
      url: `<?= base_url()?>/program/getAllMateriPertemuan/${id_pertemuan}`,
      type: "GET",
  ...
  function simpanMateriPertemuan(e) {
    ...
    let form = '#formMateriPertemuan';
    let fk_id_pertemuan_program = $(`#fk_id_pertemuan_program`).val();
    let pk_id_materi_pertemuan = $(`${form} #pk_id_materi_pertemuan`).val();
    let item = $(`${form} #item`).val();

    var fd = new FormData();
    fd.append('fk_id_pertemuan_program', fk_id_pertemuan_program);
    ...
    $.ajax({
      url: "<?= base_url()?>/program/simpanMateriPertemuan",
      type: "POST",
      dataType: "json",
      contentType: false,
      processData: false,
      ...
      success: function(response) {
        if(response.error){
          ...
          showData(fk_id_pertemuan_program);
        }
  ...
  function editMateriPertemuan(pk_id_materi_pertemuan) {
    $.ajax({
      url: "<?= base_url()?>/program/getMateriPertemuan/" + pk_id_materi_pertemuan,
      type: "get",
      dataType: "json",
      success: function(response) {
        if (response) {
  ...
  function hapusMateriPertemuan(pk_id_materi_pertemuan, tipe) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/program/hapusMateriPertemuan/" + pk_id_materi_pertemuan,
          type: "get",
  ...
  function ubahUrutanMateri(pk_id_materi_pertemuan, urutan, arah, pk_id_materi_pertemuan_other) {
    $.ajax({
      url: "<?= base_url()?>/program/ubahUrutanMateri",
      type: "POST",
      data: {
