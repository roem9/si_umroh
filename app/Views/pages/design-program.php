...
<script>
      ...
      success: function(response) {
        ...
        if (response.length > 0) {
          for (var i = 0; i < response.length; i++) {
            ...
            latihan = (obj.tipe_latihan == 'tidak ada latihan' || obj.tipe_latihan == 'Pre Test TOEFL Listening' || obj.tipe_latihan == 'Pre Test TOEFL Structure' || obj.tipe_latihan == 'Pre Test TOEFL Reading' || obj.tipe_latihan == 'Pre Test TOEFL' || obj.tipe_latihan == 'Post Test TOEFL Listening' || obj.tipe_latihan == 'Post Test TOEFL Structure' || obj.tipe_latihan == 'Post Test TOEFL Reading' || obj.tipe_latihan == 'Post Test TOEFL' || obj.tipe_latihan == 'Pre Test IELTS Listening' || obj.tipe_latihan == 'Pre Test IELTS Reading' || obj.tipe_latihan == 'Pre Test IELTS Writing' || obj.tipe_latihan == 'Pre Test IELTS' || obj.tipe_latihan == 'Post Test IELTS Listening' || obj.tipe_latihan == 'Post   Test IELTS Reading' || obj.tipe_latihan == 'Post Test IELTS Writing' || obj.tipe_latihan == 'Post   Test IELTS') ? `<span class=" badge bg-gradient-warning" data-toggle="tooltip" data-placement="top" title="tidak ada latihan">-</span>` : `<a href="<?= base_url()?>/program/latihanPertemuan/${obj.pk_id_pertemuan_program}" class="me-1">
              ...
              <tr>
                ...
                <td class="w-1">
                  <div class="text-center">
                    ...
                    <a href="<?= base_url()?>/program/materiPertemuan/${obj.pk_id_pertemuan_program}" class="me-1">
  ...
  function editPertemuanProgram(pk_id_pertemuan_program) {
    let form = '#formPertemuanProgram';
    $.ajax({
      url: "<?= base_url()?>/program/getPertemuanProgram/" + pk_id_pertemuan_program,
      type: "get",
      dataType: "json",
      success: function(response) {
        if (response) {
  ...
  function hapusPertemuanProgram(pk_id_pertemuan_program, nama_pertemuan, id_program) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/program/hapusPertemuanProgram/" + pk_id_pertemuan_program,
          type: "get",
          dataType: "json",
          success: function(response) {
            Toast.fire({
