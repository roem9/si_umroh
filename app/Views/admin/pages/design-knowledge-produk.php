  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" name="fk_id_produk" id="fk_id_produk" value="<?= $pk_id_produk ?>">
        <form id="formKnowledgeProduk">
          ...
          <input type="hidden" name="pk_id_knowledge_produk" id="pk_id_knowledge_produk">
...
<script>
  ...
  function showData(pk_id_produk) {
    $.ajax({
      url: `<?= base_url()?>/produk/getAllKnowledgeProduk/${pk_id_produk}`,
      type: "GET",
        ...
        if (data.length > 0) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (i == 0) {
              if (data.length == 1) {
                ...
                urutan = `
                          <a href="javascript:void(0)">
                            <span class="badge badge-sm bg-gradient-dark ms-1" onclick="ubahUrutanKnowledgeProduk(${obj.pk_id_knowledge_produk}, ${obj.urutan}, 'turun', ${data[i+1].pk_id_knowledge_produk})">
              ...
              urutan = `
                        <a href="javascript:void(0)">
                          <span class="badge badge-sm bg-gradient-dark ms-1" onclick="ubahUrutanKnowledgeProduk(${obj.pk_id_knowledge_produk}, ${obj.urutan}, 'naik', ${data[i-1].pk_id_knowledge_produk})">
            ...
            if (obj.item == 'text' || obj.item == 'video') {
              action = `
                <a href='javascript:void(0)' onclick='hapusKnowledgeProduk(${obj.pk_id_knowledge_produk}, "${obj.item}")'><span class="badge badge-sm bg-gradient-danger me-1">hapus</span></a>
                <a href='javascript:void(0)' onclick='editKnowledgeProduk(${obj.pk_id_knowledge_produk}, "${obj.item}")'><span class="badge badge-sm bg-gradient-success">edit</span></a>
                ${urutan}
              `
            } else {
              action = `
  ...
  function simpanKnowledgeProduk(e) {
    ...
    let pk_id_knowledge_produk = $(`${form} #pk_id_knowledge_produk`).val();
    let item = $(`${form} #item`).val();

    var fd = new FormData();
    fd.append('fk_id_produk', fk_id_produk);
    fd.append('pk_id_knowledge_produk', pk_id_knowledge_produk);
    fd.append('item', item);
    ...
    $.ajax({
      url: "<?= base_url()?>/produk/simpanKnowledgeProduk",
      type: "POST",
      dataType: "json",
      contentType: false,
      processData: false,
  ...
  function editKnowledgeProduk(pk_id_knowledge_produk) {
    $.ajax({
      url: "<?= base_url()?>/produk/getKnowledgeProduk/" + pk_id_knowledge_produk,
      type: "get",
      dataType: "json",
      success: function(response) {
        if (response) {
          ...
          $(`#formKnowledgeProduk #pk_id_knowledge_produk`).val(response.pk_id_knowledge_produk);
          $(`#formKnowledgeProduk #fk_id_produk`).val(response.fk_id_produk);
  ...
  function hapusKnowledgeProduk(pk_id_knowledge_produk, tipe) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/produk/hapusKnowledgeProduk/" + pk_id_knowledge_produk,
          type: "get",
  ...
  function ubahUrutanKnowledgeProduk(pk_id_knowledge_produk, urutan, arah, pk_id_knowledge_produk_other) {
    $.ajax({
      url: "<?= base_url()?>/produk/ubahUrutanKnowledgeProduk",
      type: "POST",
      data: {
        pk_id_knowledge_produk: pk_id_knowledge_produk,
        pk_id_knowledge_produk_other: pk_id_knowledge_produk_other,
        urutan: urutan,
        arah: arah
      },
      success: function(hasil) {
