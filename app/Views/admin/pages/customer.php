    ...
    $('#table-data').DataTable({
      ...
      columns: [
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return `
              <a href="javascript:void(0)" class="me-1" onclick='editData(${row.pk_id_customer})'>
              ...
              <a href="javascript:void(0)" onclick='hapusData(${row.pk_id_customer}, "${row.nama_customer}")'>
