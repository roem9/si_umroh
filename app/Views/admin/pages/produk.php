    ...
    $('#table-data').DataTable({
      ...
      columns: [
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return `
              <a href="javascript:void(0)" class="me-1" onclick='editData(${row.pk_id_produk})'>
              ...
              <a href="<?= base_url()?>/produk/knowledgeproduk/${row.pk_id_produk}" class="me-1">
              ...
              <a href="javascript:void(0)" onclick='hapusData(${row.pk_id_produk}, "${row.nama_produk}")'>
