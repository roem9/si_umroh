            ...
            <table class="table text-dark table-hover align-items-center mb-0" id="table-data">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder none">Jenis Komisi</th>
...
<script>
    ...
    $('#table-data').DataTable({
      ...
      columns: [{
        ...
        },
        {
          ...
          render: function(data, type, row) {
            if (data == 1) {
              ...
              return `
              <a href="javascript:void(0)" class="text-danger" onclick="toggleStatus(${row.pk_id_produk_travel}, ${row.is_active})">
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return `
              <a href="javascript:void(0)" class="me-1" onclick='editData(${row.pk_id_produk_travel})'>
              ...
              <a href="javascript:void(0)" onclick='hapusData(${row.pk_id_produk_travel}, "${row.nama_produk}")'>
  ...
  function tambahData(e) {
    ...
    let pk_id_produk_travel = $(`${form} #pk_id_produk_travel`).val();
  ...
  function hapusData(pk_id_produk_travel, nama_produk) {
    Swal.fire({
