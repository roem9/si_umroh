    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="formData">
        ...
        <div class="col-12 mb-3">
          ...
          <select name="fk_id_produk_travel" id="fk_id_produk_travel" class="multisteps-form__input form-control">
...
<script>
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return `
              ...
              <a href="javascript:void(0)" class="me-1" onclick='duplicateData(${row.pk_id_penjualan_produk_travel})'>
  ...
  function saveData(e) {
    ...
    data.append('fk_id_produk_travel', fk_id_produk_travel);
              ...
              <div class="card mb-3 shadow-none border">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-end">
                    ...
                    <a href="javascript:void(0)" onclick='hapusDataPembayaran(${pembayaran.pk_id_pembayaran_penjualan_produk_travel}, ${response.penjualan.pk_id_penjualan_produk_travel})'>
                      <span class="badge bg-gradient-danger">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                          <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5M8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5m3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0"/>
                        </svg>
  ...
  function saveDataPembayaran(e) {
    ...
    let fk_id_penjualan_produk_travel = $(`#fk_id_penjualan_produk_travel`).val();
    let pk_id_pembayaran_penjualan_produk_travel = $(`${form} #pk_id_pembayaran_penjualan_produk_travel`).val();
    ...
    data.append('fk_id_penjualan_produk_travel', fk_id_penjualan_produk_travel);
    data.append('pk_id_pembayaran_penjualan_produk_travel', pk_id_pembayaran_penjualan_produk_travel);
  ...
  function hapusDataPembayaran(pk_id_pembayaran_penjualan_produk_travel, pk_id_penjualan_produk_travel) {
    Swal.fire({
