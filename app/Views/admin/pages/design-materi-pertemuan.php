    ...
    <div class="col d-flex justify-content-end mb-3">
      <div>
        <div class="ms-auto my-auto d-none d-md-none d-lg-block">
          <button type="button" class="btn bg-gradient-info btn-sm mb-0 btnModalMateriPertemuan" data-bs-toggle="modal" data-bs-target="#modalMateriPertemuan">+&nbsp; Item Baru</a>
        </div>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header pb-0">
        <h6>List Item Materi</h6>
      </div>
      <div class="card-body">
        <div class="timeline timeline-one-side" data-timeline-axis-style="dotted" id="listMateriPertemuan">
        </div>
        <button type="button" class="btn bg-gradient-info btn-sm mb-0 btnModalMateriPertemuan w-100" data-bs-toggle="modal" data-bs-target="#modalMateriPertemuan">+&nbsp; Item Baru</a>
      </div>
    </div>
  </div>
</section>
...
<div class="modal fade" id="modalMateriPertemuan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-focus="false">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalMateriPertemuanLabel">Tambah Item Materi</h5>
        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <input type="hidden" name="fk_id_pertemuan_kelas" id="fk_id_pertemuan_kelas" value="<?= $pk_id_pertemuan_kelas ?>">
        <form id="formMateriPertemuan">
          ...
          <input type="hidden" name="pk_id_materi_pertemuan" id="pk_id_materi_pertemuan">
          <div class="data-tipe-materi">
            <div class="col-12 mb-3">
              <label for="item">Tipe Item Materi</label>
              <input type="hidden" name="item" id="item">
              <div class="invalid-feedback" data-id="item"></div>
              <div class="row" id="tipe_materi">
                <div class="col-12 mb-3">
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-10">
                          <h6>Audio</h6>
                          <p class="text-sm">
                            Materi berupa file audio. File harus berformat mp3.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-10">
                          <h6>File</h6>
                          <p class="text-sm">
                            Materi berupa file. File harus berformat pdf.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-10">
                          <h6>Gambar</h6>
                          <p class="text-sm">
                            Materi berupa gambar. File gambar harus berformat jpg, jpeg atau png.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-10">
                          <h6>Video</h6>
                          <p class="text-sm">
                            Materi berupa video dengan menginput link video dari youtube.
                          </p>
                        </div>
                      </div>
                    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    ...
    showData(<?= $pk_id_pertemuan_kelas ?>);
    ...
    $(".item").on('click', function() {
      ...
      if (data == 'audio') {
        $(".formItem").hide()
        $("#form-audio").show()
        $(`#formMateriPertemuan #form-nama-file`).show();
      } else if (data == 'file') {
        $(".formItem").hide()
        $("#form-file").show()
        $(`#formMateriPertemuan #form-nama-file`).show();
        ...
        $(".formItem").hide()
        $("#form-video").show()
        $(`#formMateriPertemuan #form-nama-file`).hide();
      } else if (data == 'text') {
        $(".formItem").hide()
        $("#form-text").show()
        $(`#formMateriPertemuan #form-nama-file`).hide();
  ...
  // kumpulan function
  function showModalMateriPertemuan(input = true) {
    let form = '#formMateriPertemuan';
    $('#modalMateriPertemuanLabel').html('Tambah Item Materi');

    bersihkanForm(`${form}`);
    bersihkanValidasi(`${form}`);
    bersihkanCardSelection(`${form}`);

    $(".data-tipe-materi").show();
    $("#form-nama-file").hide()
    $("#form-audio").hide()
    $("#form-file").hide()
    $("#form-image").hide()
  ...
  function showData(id_pertemuan) {
    $.ajax({
      url: `<?= base_url()?>/kelas/getAllMateriPertemuan/${id_pertemuan}`,
      type: "GET",
        ...
        if (data.length > 0) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (i == 0) {
              if (data.length == 1) {
                ...
                urutan = `
                          <a href="javascript:void(0)">
                            <span class="badge badge-sm bg-gradient-dark ms-1" onclick="ubahUrutanMateri(${obj.pk_id_materi_pertemuan}, ${obj.urutan}, 'turun', ${data[i+1].pk_id_materi_pertemuan})">
              ...
              urutan = `
                        <a href="javascript:void(0)">
                          <span class="badge badge-sm bg-gradient-dark ms-1" onclick="ubahUrutanMateri(${obj.pk_id_materi_pertemuan}, ${obj.urutan}, 'naik', ${data[i-1].pk_id_materi_pertemuan})">
            ...
            if (obj.item == 'text' || obj.item == 'video') {
              action = `
                <a href='javascript:void(0)' onclick='hapusMateriPertemuan(${obj.pk_id_materi_pertemuan}, "${obj.item}")'><span class="badge badge-sm bg-gradient-danger me-1">hapus</span></a>
                <a href='javascript:void(0)' onclick='editMateriPertemuan(${obj.pk_id_materi_pertemuan}, "${obj.item}")'><span class="badge badge-sm bg-gradient-success">edit</span></a>
                ${urutan}
              `
            } else {
              action = `
            ...
            if (obj.item == 'video') {
              ...
              //   <div id="scroller" class="fullscreen" style="display:none;">
              //     <object id="pdfObject" data="<?= base_url() ?>/public/assets/materi-pertemuan/file/${obj.data}" type="application/pdf" width="100%" height="100%">
              //       <p>Your browser does not support PDFs. <a href="<?= base_url() ?>/public/assets/materi-pertemuan/file/${obj.data}">Download the PDF</a>.</p>
              //     </object>
              //   </div>`
              content = `
                <a href='javascript:void(0)' class='btnPdf' data-title='${obj.data}' data-url='<?= base_url()?>/public/assets/materi-pertemuan/file/${obj.data}' data-bs-toggle="modal" data-bs-target="#pdfModal">
                  <span class="badge badge-sm bg-gradient-secondary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
                      <path d="M8.5 6.5a.5.5 0 0 0-1 0v3.793L6.354 9.146a.5.5 0 1 0-.708.708l2 2a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 10.293V6.5z" />
                      <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" />
              ...
              //             </div>`
              content = `
                <a href='javascript:void(0)' class='btnImage' data-title='${obj.data}' data-url='<?= base_url()?>/public/assets/materi-pertemuan/img/${obj.data}' data-bs-toggle="modal" data-bs-target="#imageModal">
                  <span class="badge badge-sm bg-gradient-secondary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
                      <path d="M8.5 6.5a.5.5 0 0 0-1 0v3.793L6.354 9.146a.5.5 0 1 0-.708.708l2 2a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 10.293V6.5z" />
                      <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" />
  ...
  function simpanMateriPertemuan(e) {
    ...
    let form = '#formMateriPertemuan';
    let fk_id_pertemuan_kelas = $(`#fk_id_pertemuan_kelas`).val();
    let pk_id_materi_pertemuan = $(`${form} #pk_id_materi_pertemuan`).val();
    let item = $(`${form} #item`).val();

    var fd = new FormData();
    fd.append('fk_id_pertemuan_kelas', fk_id_pertemuan_kelas);
    fd.append('pk_id_materi_pertemuan', pk_id_materi_pertemuan);
    fd.append('item', item);
    ...
    $.ajax({
      url: "<?= base_url()?>/kelas/simpanMateriPertemuan",
      type: "POST",
      dataType: "json",
      contentType: false,
      processData: false,
      ...
      success: function(response) {
        if(response.error){
          ...
          showData(fk_id_pertemuan_kelas);
        }
  ...
  function editMateriPertemuan(pk_id_materi_pertemuan) {
    $.ajax({
      url: "<?= base_url()?>/kelas/getMateriPertemuan/" + pk_id_materi_pertemuan,
      type: "get",
      dataType: "json",
      success: function(response) {
        if (response) {
          showModalMateriPertemuan(false);

          $('#modalMateriPertemuan').modal('show');
          $('#modalMateriPertemuanLabel').html('Edit Item Materi');
          $(".data-tipe-materi").hide();

          $(`#formMateriPertemuan #pk_id_materi_pertemuan`).val(response.pk_id_materi_pertemuan);
          $(`#formMateriPertemuan #fk_id_pertemuan_kelas`).val(response.fk_id_pertemuan_kelas);
          $(`#formMateriPertemuan #item`).val(response.item);
          ...
          if (response.item == 'text') {
            ...
            $("#form-video").show()
            $(`#formMateriPertemuan #video`).val(response.data);
          }
        }
      }
  ...
  function hapusMateriPertemuan(pk_id_materi_pertemuan, tipe) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url()?>/kelas/hapusMateriPertemuan/" + pk_id_materi_pertemuan,
          type: "get",
  ...
  function ubahUrutanMateri(pk_id_materi_pertemuan, urutan, arah, pk_id_materi_pertemuan_other) {
    $.ajax({
      url: "<?= base_url()?>/kelas/ubahUrutanMateri",
      type: "POST",
      data: {
        pk_id_materi_pertemuan: pk_id_materi_pertemuan,
        pk_id_materi_pertemuan_other: pk_id_materi_pertemuan_other,
        urutan: urutan,
        arah: arah
      },
      success: function(hasil) {
