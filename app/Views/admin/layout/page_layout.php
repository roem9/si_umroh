...
<body class="g-sidenav-show <?= ($title != 'Login' && $title != 'Sertifikat' && $title != 'Lengkapi Data') ? "bg-custom" : "bg-gray-100"?>">
  <?php if ($title != 'Login' && $title != 'Sertifikat' && $title != 'Lengkapi Data') : ?>
