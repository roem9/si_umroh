...
<body class="g-sidenav-show <?= ($title != 'Login' && $title != 'Sertifikat' && $title != 'Registrasi Agent') ? "bg-custom" : "bg-gray-100"?>">
  <?php if ($title != 'Login' && $title != 'Sertifikat' && $title != 'Registrasi Agent') : ?>
