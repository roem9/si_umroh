...
<body class="g-sidenav-show <?= ($title != 'Login' && $title != 'Sertifikat' && $title != 'Registrasi Agent' && $title != 'Lengkapi Data' && $title != 'Lupa Password') ? "bg-custom" : "bg-gray-100"?>">
  <?php if ($title != 'Login' && $title != 'Sertifikat' && $title != 'Registrasi Agent' && $title != 'Lengkapi Data' && $title != 'Lupa Password') : ?>
