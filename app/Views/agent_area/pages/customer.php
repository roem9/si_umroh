    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="formData">
        ...
        <div class="col-12 mb-3">
          ...
          <input class="form-control" list="listprovinsi" name="provinsi" id="provinsi" placeholder="" autocomplete="off" disabled>
        ...
        <div class="col-12 mb-3">
          ...
          <input class="form-control" list="listkota_kabupaten" name="kota_kabupaten" id="kota_kabupaten" placeholder="" autocomplete="off" disabled>
        ...
        <div class="col-12 mb-3">
          ...
          <input class="form-control" list="listkecamatan" name="kecamatan" id="kecamatan" placeholder="" autocomplete="off" disabled>
        ...
        <div class="col-12 mb-3">
          ...
          <input class="form-control" list="listkelurahan" name="kelurahan" id="kelurahan" placeholder="" autocomplete="off" disabled>
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response) {
          ...
          $(`${form} #no_wa`).val(response.no_wa_customer);
          ...
          $(`${form} #email`).val(response.email_customer);
