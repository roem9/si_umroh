...
<script>
  ...
  function showData() {
    $.ajax({
      url: `<?= base_url()?>/ainformasi/getAllInformasi`,
      type: "GET",
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            if (obj.item == 'video') {
              ...
              content = `
                ...
                <br>
                <a class="btn btn-sm bg-gold-custom mt-2" href="<?= base_url()?>/public/assets/informasi/file/${obj.data}" download="${obj.data}">Download</a>
              `;
              ...
              content = ` <h6 class="text-dark text-sm font-weight-bold mb-2">Audio</h6>
                          ...
                          <br>
                          <a class="btn btn-sm bg-gold-custom mt-2" href="<?= base_url()?>/public/assets/informasi/audio/${obj.data}" download="${obj.data}">Download</a>
                          `
              ...
              content = `
                ...
                <br>
                <a class="btn btn-sm bg-gold-custom mt-2" href="<?= base_url()?>/public/assets/informasi/img/${obj.data}" download="${obj.data}">Download</a>
              `;
            }
