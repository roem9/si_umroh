    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main" data-color="info">
      ...
      <div class="collapse navbar-collapse w-auto h-auto pb-0" id="sidenav-collapse-mai">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link <?= ($sidebar == "agent") ? 'active' : '' ?>" href="<?= base_url('agent') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            ...
            <div class="collapse <?= (isset($collapse) && $collapse === "member") ? 'show' : ''?>" id="sidebarMember" style="">
              <ul class="nav ms-4 ps-3">
                <li class="nav-item ">
                  <a class="nav-link <?= (isset($collapse) && $collapse === "member" && isset($collapseItem) && $collapseItem == 'listMember') ? 'active' : ''?>" href="<?= base_url()?>/member">
                    <span class="sidenav-normal"> List Member </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link <?= (isset($collapse) && $collapse === "member" && isset($collapseItem) && $collapseItem == 'waitingList') ? 'active' : ''?>" href="<?= base_url()?>/wl">
